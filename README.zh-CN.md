...
<p align="center">
  <a href="https://github.com/zylos-ai/zylos-core">Zylos</a> 智能体的 Lark（国际版）通讯组件。
</p>
...
> 本组件仅面向 Lark 国际版。飞书（中国版）请使用独立的 feishu 组件。

- **通过 Lark 对话** — 你的 AI 智能体接入 Lark，支持私聊和群聊
- **智能群组监控** — 自动关注指定群组的所有讨论，无需 @
- **零配置启动** — 第一条消息自动绑定为管理员，无需繁琐设置
- **丰富的 Lark 集成** — 文档、表格、日历 — 不止是消息收发
...
Zylos 会引导你完成设置，包括配置 Lark 应用凭证。安装完成后，在 Lark 上给机器人发消息 — 第一个交互的用户自动成为管理员。
