...
### Added
- **Rejection response**: When C4 rejects a message (health down/recovering), bot replies to the user via `sendMessage` with the rejection reason instead of silently failing
